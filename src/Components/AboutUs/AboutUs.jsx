            ...
            <div className='container py-5'>
                <div className='row'>
                    ...
                    <div className='col-md-6'>
                        ...
                        <div className='row bg-dark text-white p-3 mb-3 row-cols-sm-1 row-cols-md-1 row-cols-lg-2 d-flex'>
                            <div className=''>
                        ...
                        <div className='row'>
                            <div className='col-6'>
                                ...
                                <div className='bg-white p-3 rounded-3 mb-3'>
                                    <h5>Unlock Your Musical Talents</h5>
                                    <p>Our team of experienced and passionate instructors are dedicated to guiding you on a transformative journey of self-discovery and artistic growth</p>
                                </div>
                            </div>
                            <div className='col-6'>
                                <div className='bg-white p-3 rounded-3 mb-3'>
